...
# Read the file
with open('/Users/karthikvenkatesan/Contract_Intelli_Agent/backend/services/document_processing_service.py', 'r') as f:
    content = f.read()
...
# Write back
with open('/Users/karthikvenkatesan/Contract_Intelli_Agent/backend/services/document_processing_service.py', 'w') as f:
    f.write(content)
